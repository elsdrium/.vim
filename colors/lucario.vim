...
" Modified by HM Chen  (June 13, 2016)
"
...
hi IncSearch    ctermfg=23 ctermbg=186 cterm=bold guifg=#2b3e50 guibg=#e6db74 gui=NONE
hi Search       ctermfg=0 ctermbg=222 cterm=bold,underline guifg=NONE guibg=NONE gui=underline
