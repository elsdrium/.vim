...
let s:visual_black = { "gui": "NONE", "cterm": "0", "cterm16": s:black.cterm16 } " Black out selected text in 16-color visual mode
...
let s:visual_pink = { "gui": "#3E4451", "cterm": "175", "cterm16": "15" }
...
call s:h("IncSearch", { "fg": s:visual_black, "bg": s:visual_pink }) " 'incsearch' highlighting; also used for the text replaced with ":s///c"
...
call s:h("PmenuSel", { "bg": s:visual_pink }) " Popup menu: selected item.
call s:h("PmenuSbar", { "bg": s:visual_pink }) " Popup menu: scrollbar.
call s:h("PmenuThumb", { "bg": s:white }) " Popup menu: Thumb of the scrollbar.
call s:h("Question", { "fg": s:purple }) " hit-enter prompt and yes/no questions
call s:h("Search", { "fg": s:visual_black, "bg": s:visual_pink }) " Last search pattern highlighting (see 'hlsearch'). Also used for highlighting the current line in the quickfix window and similar items that need to stand out.
...
call s:h("Visual", { "fg": s:visual_black, "bg": s:visual_pink }) " Visual mode selection
call s:h("VisualNOS", { "bg": s:visual_pink }) " Visual mode selection when vim is "Not Owning the Selection". Only X11 Gui's gui-x11 and xterm-clipboard supports this.
